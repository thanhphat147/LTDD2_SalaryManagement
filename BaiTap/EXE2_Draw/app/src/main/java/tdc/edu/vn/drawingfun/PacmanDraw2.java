...
public class PacmanDraw2 extends View {
    ...
    public PacmanDraw2(Context context) {
        super(context);
        initPaint();
    }

    public PacmanDraw2(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPaint();
    }

    public PacmanDraw2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initPaint();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public PacmanDraw2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
